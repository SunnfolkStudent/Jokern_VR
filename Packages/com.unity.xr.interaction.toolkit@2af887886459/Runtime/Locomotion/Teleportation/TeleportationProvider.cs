...
namespace UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation
{
    ...
    public class TeleportationProvider : LocomotionProvider
    {
        ...
        [SerializeField]
        [Tooltip("How many steps until teleport destination is reached")]
        float speed;
        ...
        protected virtual void Update()
        {
            ...
            if (locomotionState == LocomotionState.Moving)
            {
                ...
                */
                ...
                positionTransformation.targetPosition = Vector3.MoveTowards(positionTransformation.targetPosition, currentRequest.destinationPosition, speed * Time.deltaTime);
                TryQueueTransformation(positionTransformation);

                if (positionTransformation.targetPosition == currentRequest.destinationPosition)
                {
                    TryEndLocomotion();
                    validRequest = false;
                }
